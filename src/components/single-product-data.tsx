            ...
            {pro_data && !isRowView ?
                <div className="relative border border-muted rounded-lg" >
                    <Link href={`/product/${pro_data.slug}`} className="  relative block bg-white p-2 mx-auto rounded-lg rounded-b-none  w-full">
                        ...
                        {pro_data.offers ?
                            <div className="absolute right-3 top-3 bg-red-500 rounded-full text-white text-sm p-[5px] shadow-lg text-center overflow-hidden leading-3 label-circle w-[3rem] h-[3rem]" >
                        ...
                        <div className="mt-5">
                            ...
                            <div className="flex justify-between mt-3 items-center">
                                ...
                                {addedToCartClicked && getProductQuantity(pro_data.id) > 0 ?
                                    ...
                                    }} className="bg-[#39f] text-white px-2 flex  justify-center flex-1  sm:flex-none lg:py-1 py-1 rounded">
