...
const ProductsPageData = ({ data, cat_data, brands_data }: { data: any, cat_data: any, brands_data: any }) => {
                                        ...
                                        <AccordionContent className="" >
                                            {brands_data ?
                                                brands_data.data.brands.map((brand: any) => (
                                                    ...
                                                    <div onClick={(e) => { (e.target as HTMLElement).classList.add('!bg-blue-500', '!text-white') }} className="cursor-pointer text-blue-500 border border-blue-500 px-2 py-1 text-center my-1 mr-2 rounded-full hover:bg-blue-500 hover:text-white inline-block text-xs">{brand.name}</div>
